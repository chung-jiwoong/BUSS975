...
- These slides are based on Scott Cunningham, *Causal Inference: The Remix* (2nd ed.), Chapter 4, "Potential Outcomes and Randomization."
  - Free online: `https://mixtape.scunning.com`
- The regression material in Part 6 is adapted from Todd Gormley's lecture notes.
...
- But note the heterogeneity: effects range from $+7$ to $-2$.
  - An average can hide winners and losers. Remember this in week 10 (complex DiD).
...
- Randomization inference is not a curiosity:
  - **Synthetic control** (week 11): placebo tests permute the treatment across donor units --- that *is* randomization inference.
