...
The mean version, \(E[X \mid D{=}1, e(X)] = E[X \mid D{=}0, e(X)]\), is
what a balance table tests.
\end{frame}
...
The \(ATE\) is identified by comparing treated and control units at the
same \textbf{score} rather than the same \(X\):
